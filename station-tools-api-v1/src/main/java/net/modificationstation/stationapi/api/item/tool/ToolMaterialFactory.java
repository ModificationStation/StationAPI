...
public class ToolMaterialFactory {
    ...
    private static void initializeMaterial(ToolMaterial toolMaterial, int miningLevel, int durability, float miningSpeed, int attackDamage) {
        ...
        accessor.stationapi$setMiningLevel(miningLevel);
        accessor.stationapi$setDurability(durability);
        accessor.stationapi$setMiningSpeed(miningSpeed);
        accessor.stationapi$setAttackDamage(attackDamage);
    }
}
