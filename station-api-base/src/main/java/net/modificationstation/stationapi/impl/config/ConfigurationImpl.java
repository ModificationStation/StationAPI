...
public class ConfigurationImpl implements Configuration {
    ...
    private final Set<net.modificationstation.stationapi.api.config.Category> categories = new TreeSet<>();
    ...
    @Override
    public net.modificationstation.stationapi.api.config.Category getCategory(String name) {
        for (net.modificationstation.stationapi.api.config.Category category : categories)
            if (name.equals(category.getName()))
                return category;
        net.modificationstation.stationapi.api.config.Category category = GeneralFactory.INSTANCE.newInst(net.modificationstation.stationapi.api.config.Category.class, name);
    ...
    public void load(BufferedReader buffer) {
        net.modificationstation.stationapi.api.config.Category currentCategory = null;
        String line;
        while (true) {
            try {
