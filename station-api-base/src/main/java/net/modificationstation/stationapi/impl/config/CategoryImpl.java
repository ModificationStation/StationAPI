...
public class CategoryImpl implements net.modificationstation.stationapi.api.config.Category {
    ...
    @Override
    public int compareTo(net.modificationstation.stationapi.api.config.Category o) {
        return getName().compareTo(o.getName());
    }

    @Override
    public boolean equals(Object o) {
        return o instanceof net.modificationstation.stationapi.api.config.Category && getName().equals(((net.modificationstation.stationapi.api.config.Category) o).getName());
    }
}
