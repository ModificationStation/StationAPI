...
public class StationFlowingWaterTextureBinder extends StationTextureBinder implements TexturePackDependent {
    ...
    public StationFlowingWaterTextureBinder() {
        super(SquareAtlas.TERRAIN.getTexture(BlockBase.FLOWING_WATER.texture + 1));
        textureSize = 2;
        refreshTextures();
    }
