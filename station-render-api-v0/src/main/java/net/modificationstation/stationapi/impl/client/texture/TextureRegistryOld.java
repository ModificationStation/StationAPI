...
public class TextureRegistryOld implements net.modificationstation.stationapi.api.client.texture.TextureRegistryOld {

    private static final Set<TextureRegistryOld> registries = new TreeSet<>();
    public static final TextureRegistryOld
            TERRAIN = new TextureRegistryOld("TERRAIN", "/terrain.png", 16, 16),
            PARTICLES = new TextureRegistryOld("PARTICLES", "/particles.png", 32, 32),
            GUI_ITEMS = new TextureRegistryOld("GUI_ITEMS", "/gui/items.png", 16, 16),
            GUI_PARTICLES = new TextureRegistryOld("GUI_PARTICLES", "/gui/particles.png", 32, 32);
    private static TextureRegistryOld currentRegistry;
    ...
    public TextureRegistryOld(String name, String path, int texturesInLine, int texturesInColumn) {
        this.name = name;
    ...
    public static Object getRegistry(Object name) {
        for (net.modificationstation.stationapi.api.client.texture.TextureRegistryOld registry : registries())
            if (name.equals(registry.name()))
                return registry;
        return null;
    }

    public static net.modificationstation.stationapi.api.client.texture.TextureRegistryOld currentRegistry() {
        return currentRegistry;
    }

    public static Collection<net.modificationstation.stationapi.api.client.texture.TextureRegistryOld> registries() {
    ...
    @Override
    public int compareTo(net.modificationstation.stationapi.api.client.texture.TextureRegistryOld o) {
