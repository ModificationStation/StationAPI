...
public class CustomModelRenderer extends EntityRenderer {
    public final CustomModel entityModelBase;
    ...
    public CustomModelRenderer(String path, ModID modid) {
        try {
            ...
            throw new IllegalArgumentException("Could not find JSON model! Check your path and try again.");
        }
    }
