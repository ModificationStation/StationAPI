...
import net.modificationstation.stationapi.api.client.model.BakedQuadFactory;
import net.modificationstation.stationapi.api.client.model.BasicBakedModel;
import net.modificationstation.stationapi.api.client.model.BuiltinBakedModel;
import net.modificationstation.stationapi.api.client.model.ItemModelGenerator;
...
public final class JsonUnbakedModel implements UnbakedModel {
    ...
    public Collection<SpriteIdentifier> getTextureDependencies(Function<Identifier, UnbakedModel> unbakedModelGetter, Set<Pair<String, String>> unresolvedTextureReferences) {
        ...
        for (ModelElement modelElement : this.getElements()) {
            ...
            for (ModelElementFace modelElementFace : modelElement.faces.values()) {
                ...
                if (Objects.equals(spriteIdentifier.texture, ExpandableAtlas.MISSING)) {
    ...
    public boolean textureExists(String name) {
        return !ExpandableAtlas.MISSING.equals(this.resolveSprite(name).texture);
    }
    ...
    public SpriteIdentifier resolveSprite(String spriteName) {
        ...
        while(true) {
            ...
            if (list.contains(spriteName)) {
                ...
                return SpriteIdentifier.of(Atlases.BLOCK_ATLAS_TEXTURE, ExpandableAtlas.MISSING);
            }
    ...
    private Either<SpriteIdentifier, String> resolveTexture(String name) {
        ...
        return Either.left(SpriteIdentifier.of(Atlases.BLOCK_ATLAS_TEXTURE, ExpandableAtlas.MISSING));
    }
