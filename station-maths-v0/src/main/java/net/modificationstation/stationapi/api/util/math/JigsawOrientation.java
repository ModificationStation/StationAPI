...
public enum JigsawOrientation implements StringIdentifiable {
    DOWN_EAST("down_east", Direction.DOWN, Direction.NORTH),
    DOWN_NORTH("down_north", Direction.DOWN, Direction.WEST),
    DOWN_SOUTH("down_south", Direction.DOWN, Direction.EAST),
    DOWN_WEST("down_west", Direction.DOWN, Direction.SOUTH),
    UP_EAST("up_east", Direction.UP, Direction.NORTH),
    UP_NORTH("up_north", Direction.UP, Direction.WEST),
    UP_SOUTH("up_south", Direction.UP, Direction.EAST),
    UP_WEST("up_west", Direction.UP, Direction.SOUTH),
    WEST_UP("west_up", Direction.SOUTH, Direction.UP),
    EAST_UP("east_up", Direction.NORTH, Direction.UP),
    NORTH_UP("north_up", Direction.WEST, Direction.UP),
    SOUTH_UP("south_up", Direction.EAST, Direction.UP);
