...
public class ArsenicCompass extends StationTextureBinder {
    ...
    public void tick() {
        ...
        for(int var1 = 0; var1 < textureWidth * textureHeight; ++var1) {
            ...
            this.pixels[var1 * 4] = (byte)r;
            this.pixels[var1 * 4 + 1] = (byte)g;
            this.pixels[var1 * 4 + 2] = (byte)b;
            this.pixels[var1 * 4 + 3] = (byte)a;
        }
        ...
        for(int var9 = -textureHeight / 4; var9 <= textureHeight / 4; ++var9) {
            ...
            this.pixels[var12 * 4] = (byte)var13;
            this.pixels[var12 * 4 + 1] = (byte)var14;
            this.pixels[var12 * 4 + 2] = (byte)var15;
            this.pixels[var12 * 4 + 3] = (byte)var16;
        }
        ...
        for(int var27 = -textureWidth / 2; var27 <= textureWidth; ++var27) {
            ...
            this.pixels[var30 * 4] = (byte)var31;
            this.pixels[var30 * 4 + 1] = (byte)var32;
            this.pixels[var30 * 4 + 2] = (byte)var33;
            this.pixels[var30 * 4 + 3] = (byte)var34;
        }
    }
}
