...
public class TextureHelper {
	...
	static {
		UVLOCKERS[Direction.SOUTH.getId()] = (q, i, t) -> q.sprite(i, t, 1 - q.z(i), 1 - q.y(i));
		UVLOCKERS[Direction.NORTH.getId()] = (q, i, t) -> q.sprite(i, t, q.z(i), 1 - q.y(i));
		UVLOCKERS[Direction.EAST.getId()] = (q, i, t) -> q.sprite(i, t, 1 - q.x(i), 1 - q.y(i));
		UVLOCKERS[Direction.WEST.getId()] = (q, i, t) -> q.sprite(i, t, q.x(i), 1 - q.y(i));
