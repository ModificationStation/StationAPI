package net.modificationstation.stationapi.template.item.tool;
...
public class TemplateToolBase extends net.minecraft.item.tool.ToolBase implements IItemTemplate<TemplateToolBase> {
