...
public class RedstoneOre extends net.minecraft.block.RedstoneOre implements IBlockTemplate<RedstoneOre> {
    ...
    @Override
    public RedstoneOre setSounds(BlockSounds sounds) {
    ...
    @Override
    public RedstoneOre setTranslationKey(String string) {
