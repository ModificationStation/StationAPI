...
public class Stone extends net.minecraft.block.Stone implements IBlockTemplate<Stone> {
    ...
    @Override
    public Stone setSounds(BlockSounds sounds) {
    ...
    @Override
    public Stone setTranslationKey(String string) {
