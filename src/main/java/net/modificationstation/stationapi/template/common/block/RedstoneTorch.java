...
public class RedstoneTorch extends net.minecraft.block.RedstoneTorch implements IBlockTemplate<RedstoneTorch> {
    ...
    @Override
    public RedstoneTorch setSounds(BlockSounds sounds) {
    ...
    @Override
    public RedstoneTorch setTranslationKey(String string) {
