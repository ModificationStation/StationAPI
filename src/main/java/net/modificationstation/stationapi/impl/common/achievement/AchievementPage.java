 ...
 */
public class AchievementPage implements net.modificationstation.stationapi.api.common.achievement.AchievementPage {
    ...
    public AchievementPage(String pageName) {
        ...
        net.modificationstation.stationapi.api.common.achievement.AchievementPageManager.INSTANCE.addPage(this);
    }
