...
public final class ItemStack
{
    ...
    public void func_28143_a(World world, Entity entity, int i, boolean flag)
    {
        ...
        Item.itemsList[itemID].func_28018_a(this, world, entity, i, flag);
    }

    public void func_28142_b(World world, EntityPlayer entityplayer)
    {
        entityplayer.addStat(StatList.field_25093_z[itemID], stackSize);
        Item.itemsList[itemID].func_28020_c(this, world, entityplayer);
    }
