    ...
    implements IChunkProvider
{
    ...
    private double[] func_28071_a(double ad[], int i, int j, int k, int l, int i1, int j1)
    {
        ...
        d *= 2D;
        field_28091_d = field_28082_m.generateNoiseOctaves(field_28091_d, i, j, k, l, i1, j1, d / 80D, d1 / 160D, d / 80D);
        field_28090_e = field_28084_k.generateNoiseOctaves(field_28090_e, i, j, k, l, i1, j1, d, d1, d);
        field_28089_f = field_28083_l.generateNoiseOctaves(field_28089_f, i, j, k, l, i1, j1, d, d1, d);
        int k1 = 0;
        int l1 = 0;
        int i2 = 16 / l;
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        int k = i * 16;
        int l = j * 16;
        BiomeGenBase biomegenbase = field_28079_p.getWorldChunkManager().getBiomeGenAt(k + 16, l + 16);
        ...
        if(field_28085_j.nextInt(4) == 0)
        {
            ...
            (new WorldGenLakes(Block.waterStill.blockID)).generate(field_28079_p, field_28085_j, i1, l4, i8);
        }
        if(field_28085_j.nextInt(8) == 0)
        {
            ...
            {
                (new WorldGenLakes(Block.lavaStill.blockID)).generate(field_28079_p, field_28085_j, j1, i5, j8);
            }
        }
        for(int k1 = 0; k1 < 8; k1++)
        {
            ...
            (new WorldGenDungeons()).generate(field_28079_p, field_28085_j, j5, k8, i13);
        }
        ...
        for(int i2 = 0; i2 < 10; i2++)
        {
            ...
            (new WorldGenClay(32)).generate(field_28079_p, field_28085_j, k5, l8, j13);
        }
        ...
        for(int j2 = 0; j2 < 20; j2++)
        {
            ...
            (new WorldGenMinable(Block.dirt.blockID, 32)).generate(field_28079_p, field_28085_j, l5, i9, k13);
        }
        ...
        for(int k2 = 0; k2 < 10; k2++)
        {
            ...
            (new WorldGenMinable(Block.gravel.blockID, 32)).generate(field_28079_p, field_28085_j, i6, j9, l13);
        }
        ...
        for(int i3 = 0; i3 < 20; i3++)
        {
            ...
            (new WorldGenMinable(Block.oreCoal.blockID, 16)).generate(field_28079_p, field_28085_j, j6, k9, i14);
        }
        ...
        for(int j3 = 0; j3 < 20; j3++)
        {
            ...
            (new WorldGenMinable(Block.oreIron.blockID, 8)).generate(field_28079_p, field_28085_j, k6, l9, j14);
        }
        ...
        for(int k3 = 0; k3 < 2; k3++)
        {
            ...
            (new WorldGenMinable(Block.oreGold.blockID, 8)).generate(field_28079_p, field_28085_j, l6, i10, k14);
        }
        ...
        for(int l3 = 0; l3 < 8; l3++)
        {
            ...
            (new WorldGenMinable(Block.oreRedstone.blockID, 7)).generate(field_28079_p, field_28085_j, i7, j10, l14);
        }
        ...
        for(int i4 = 0; i4 < 1; i4++)
        {
            ...
            (new WorldGenMinable(Block.oreDiamond.blockID, 7)).generate(field_28079_p, field_28085_j, j7, k10, i15);
        }
        ...
        for(int j4 = 0; j4 < 1; j4++)
        {
            ...
            (new WorldGenMinable(Block.oreLapis.blockID, 6)).generate(field_28079_p, field_28085_j, k7, l10, j15);
        }

        d = 0.5D;
        int k4 = (int)((field_28092_c.func_647_a((double)k * d, (double)l * d) / 8D + field_28085_j.nextDouble() * 4D + 4D) / 3D);
        int l7 = 0;
        ...
        for(int i11 = 0; i11 < l7; i11++)
        {
            ...
            WorldGenerator worldgenerator = biomegenbase.getRandomWorldGenForTrees(field_28085_j);
            worldgenerator.func_420_a(1.0D, 1.0D, 1.0D);
            worldgenerator.generate(field_28079_p, field_28085_j, k15, field_28079_p.getHeightValue(k15, j18), j18);
        }
        ...
        for(int j11 = 0; j11 < 2; j11++)
        {
            ...
            (new WorldGenFlowers(Block.plantYellow.blockID)).generate(field_28079_p, field_28085_j, l15, k18, i21);
        }
        ...
        if(field_28085_j.nextInt(2) == 0)
        {
            ...
            (new WorldGenFlowers(Block.plantRed.blockID)).generate(field_28079_p, field_28085_j, k11, i16, l18);
        }
        if(field_28085_j.nextInt(4) == 0)
        {
            ...
            (new WorldGenFlowers(Block.mushroomBrown.blockID)).generate(field_28079_p, field_28085_j, l11, j16, i19);
        }
        if(field_28085_j.nextInt(8) == 0)
        {
            ...
            (new WorldGenFlowers(Block.mushroomRed.blockID)).generate(field_28079_p, field_28085_j, i12, k16, j19);
        }
        for(int j12 = 0; j12 < 10; j12++)
        {
            ...
            (new WorldGenReed()).generate(field_28079_p, field_28085_j, l16, k19, j21);
        }
        ...
        if(field_28085_j.nextInt(32) == 0)
        {
            ...
            (new WorldGenPumpkin()).generate(field_28079_p, field_28085_j, k12, i17, l19);
        }
        int l12 = 0;
        if(biomegenbase == BiomeGenBase.desert)
        {
        ...
        for(int j17 = 0; j17 < l12; j17++)
        {
            ...
            (new WorldGenCactus()).generate(field_28079_p, field_28085_j, i20, k21, k22);
        }
        ...
        for(int k17 = 0; k17 < 50; k17++)
        {
            ...
            (new WorldGenLiquids(Block.waterMoving.blockID)).generate(field_28079_p, field_28085_j, j20, l21, l22);
        }

        for(int l17 = 0; l17 < 20; l17++)
        {
            int k20 = k + field_28085_j.nextInt(16) + 8;
            int i22 = field_28085_j.nextInt(field_28085_j.nextInt(field_28085_j.nextInt(112) + 8) + 8);
            int i23 = l + field_28085_j.nextInt(16) + 8;
            (new WorldGenLiquids(Block.lavaMoving.blockID)).generate(field_28079_p, field_28085_j, k20, i22, i23);
        }
        ...
        for(int i18 = k + 8; i18 < k + 8 + 16; i18++)
        {
            for(int l20 = l + 8; l20 < l + 8 + 16; l20++)
            {
                ...
                {
                    field_28079_p.setBlockWithNotify(i18, k23, l20, Block.snow.blockID);
                }
            }
