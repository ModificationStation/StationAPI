...
public class EntityArrow extends Entity
{
    ...
    public EntityArrow(World world, EntityLiving entityliving)
    {
        ...
        ticksInAir = 0;
        owner = entityliving;
        field_28012_a = entityliving instanceof EntityPlayer;
        setSize(0.5F, 0.5F);
    ...
    public void writeEntityToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setByte("inData", (byte)field_28011_h);
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        if(inGround && field_28012_a && arrowShake <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1)))
        {
