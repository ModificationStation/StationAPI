...
public class BlockPistonBase extends Block
{
    ...
    public int getBlockTextureFromSideAndMetadata(int i, int j)
    {
        ...
        return i != PistonBlockTextures.field_31052_a[k] ? 108 : 109;
    }
    ...
    private void updatePistonState(World world, int i, int j, int k)
    {
        ...
        boolean flag = isPowered(world, i, j, k, i1);
        if(l == 7)
        {
            return;
        }
    ...
    public void playBlock(World world, int i, int j, int k, int l, int i1)
    {
        ...
        if(l == 1)
        {
            TileEntity tileentity = world.getBlockTileEntity(i + PistonBlockTextures.field_31051_b[j1], j + PistonBlockTextures.field_31054_c[j1], k + PistonBlockTextures.field_31053_d[j1]);
            ...
            if(isSticky)
            {
                int k1 = i + PistonBlockTextures.field_31051_b[j1] * 2;
                int l1 = j + PistonBlockTextures.field_31054_c[j1] * 2;
                int i2 = k + PistonBlockTextures.field_31053_d[j1] * 2;
                ...
                {
                    ignoreUpdates = false;
                    world.setBlockWithNotify(i + PistonBlockTextures.field_31051_b[j1], j + PistonBlockTextures.field_31054_c[j1], k + PistonBlockTextures.field_31053_d[j1], 0);
                    ignoreUpdates = true;
                }
            } else
            {
    ...
    {
        int i1 = i + PistonBlockTextures.field_31051_b[l];
        int j1 = j + PistonBlockTextures.field_31054_c[l];
        int k1 = k + PistonBlockTextures.field_31053_d[l];
        int l1 = 0;
        do
        {
            if(l1 >= 13)
            ...
            i1 += PistonBlockTextures.field_31051_b[l];
            j1 += PistonBlockTextures.field_31054_c[l];
            k1 += PistonBlockTextures.field_31053_d[l];
            l1++;
        } while(true);
        return true;
    }
    ...
    private boolean tryExtend(World world, int i, int j, int k, int l)
    {
        ...
        {
            int i2 = i1 - PistonBlockTextures.field_31051_b[l];
            int k2 = j1 - PistonBlockTextures.field_31054_c[l];
            l2 = k1 - PistonBlockTextures.field_31053_d[l];
