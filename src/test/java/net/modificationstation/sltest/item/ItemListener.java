...
public class ItemListener {
    ...
    public void registerItems(ItemRegistryEvent event) {
        ...
        testPickaxe = new ModdedPickaxeItem(MODID.id("test_pickaxe"), testMaterial).setTranslationKey(MODID, "testPickaxe"); //8476
        ...
        testShears = new TestShearsItem(MODID.id("test_shears")).setTranslationKey(MODID, "test_shears");
        pacifistSword = new PacifistSwordItem(MODID.id("pacifist_sword")).setTranslationKey(MODID, "pacifist_sword");
        dullPickaxe = new DullPickaxeItem(MODID.id("dull_pickaxe")).setTranslationKey(MODID, "dull_pickaxe");
    }
