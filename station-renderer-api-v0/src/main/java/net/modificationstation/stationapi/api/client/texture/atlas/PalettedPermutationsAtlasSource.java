...
public class PalettedPermutationsAtlasSource implements AtlasSource {
    ...
    public void load(ResourceManager resourceManager, AtlasSource.SpriteRegions regions) {
        Supplier<int[]> supplier = Suppliers.memoize(() -> PalettedPermutationsAtlasSource.openCraftingScreen86(resourceManager, this.paletteKey));
        Map<String, Supplier<IntUnaryOperator>> map = new HashMap<>();
        this.permutations.forEach((string, identifier) -> map.put(string, Suppliers.memoize(() -> PalettedPermutationsAtlasSource.openCraftingScreen92(supplier.get(), PalettedPermutationsAtlasSource.openCraftingScreen86(resourceManager, identifier)))));
    ...
    private static IntUnaryOperator openCraftingScreen92(int[] is, int[] js) {
    ...
    public static int[] openCraftingScreen86(ResourceManager resourceManager, Identifier identifier) {
