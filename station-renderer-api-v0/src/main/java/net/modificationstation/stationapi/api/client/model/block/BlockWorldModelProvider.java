...
public interface BlockWorldModelProvider extends BlockWithWorldRenderer {
    ...
    default boolean renderWorld(BlockRenderer blockRenderer, BlockView blockView, int x, int y, int z) {
        ...
        return BAKED_MODEL_RENDERER.get().render(blockView, getCustomWorldModel(blockView, x, y, z).getBaked(), state, pos, true, new Random(), state.getRenderingSeed(pos), OverlayTexture.DEFAULT_UV);
    }
}
