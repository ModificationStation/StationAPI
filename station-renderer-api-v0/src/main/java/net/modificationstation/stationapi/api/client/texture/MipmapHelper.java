    ...
    public static NativeImage[] getMipmapLevelsImages(NativeImage image, int mipmap) {
        ...
        if (mipmap > 0) {
            ...
            for (int k = 1; k <= mipmap; ++k) {
                ...
                for (int n = 0; n < l; ++n) {
                    for (int o = 0; o < m; ++o) {
                        nativeImage2.setColor(n, o, MipmapHelper.blend(nativeImage.getColor(n * 2, o * 2), nativeImage.getColor(n * 2 + 1, o * 2), nativeImage.getColor(n * 2, o * 2 + 1), nativeImage.getColor(n * 2 + 1, o * 2 + 1), bl));
                    }
                }
