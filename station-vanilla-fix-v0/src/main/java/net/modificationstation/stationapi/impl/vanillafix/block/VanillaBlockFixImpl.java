...
public final class VanillaBlockFixImpl {
    ...
    private static void registerBlocks(BlockRegistryEvent event) {
        ...
        register(registry, "gold_ore", GOLD_ORE.setMiningLevel(MiningLevels.IRON));
        register(registry, "iron_ore", IRON_ORE.setMiningLevel(MiningLevels.STONE));
        ...
        register(registry, "lapis_ore", LAPIS_LAZULI_ORE.setMiningLevel(MiningLevels.STONE));
        register(registry, "lapis_block", LAPIS_LAZULI_BLOCK.setMiningLevel(MiningLevels.STONE));
        ...
        register(registry, "gold_block", GOLD_BLOCK.setMiningLevel(MiningLevels.IRON));
        register(registry, "iron_block", IRON_BLOCK.setMiningLevel(MiningLevels.STONE));
        ...
        register(registry, "obsidian", OBSIDIAN.setMiningLevel(MiningLevels.DIAMOND));
        ...
        register(registry, "diamond_ore", DIAMOND_ORE.setMiningLevel(MiningLevels.IRON));
        register(registry, "diamond_block", DIAMOND_BLOCK.setMiningLevel(MiningLevels.IRON));
        ...
        register(registry, "redstone_ore", REDSTONE_ORE.setMiningLevel(MiningLevels.IRON));
        register(registry, "redstone_ore_lit", REDSTONE_ORE_LIT.setMiningLevel(MiningLevels.IRON));
