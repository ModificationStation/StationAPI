...
public class FixedBirchTree extends BirchTree {
    @Override
        ...
        for (n4 = j - 3 + n6; n4 <= j + n6; ++n4) {
            ...
            for (n = i - n2; n <= i + n2; ++n) {
                ...
                for (int i2 = k - n2; i2 <= k + n2; ++i2) {
                    ...
                    ((StationFlatteningWorld) arg).setBlockState(n, n4, i2, ((BlockStateHolder) Blocks.BIRCH_LEAVES).getDefaultState());
                }
            }
        }
        for (n4 = 0; n4 < n6; ++n4) {
            ...
            ((StationFlatteningWorld) arg).setBlockState(i, j + n4, k, ((BlockStateHolder) Blocks.BIRCH_LOG).getDefaultState());
        }
        return true;
    }
}
