...
public abstract class AbstractInt2ObjectMapBackedLegacyRegistry<T> extends AbstractLegacyRegistry<T> {
    ...
    public AbstractInt2ObjectMapBackedLegacyRegistry(@NotNull RegistryKey<? extends Registry<T>> key) {
        super(key);
    }

    public AbstractInt2ObjectMapBackedLegacyRegistry(@NotNull RegistryKey<? extends Registry<T>> key, boolean shiftSerialIDOnRegister) {
